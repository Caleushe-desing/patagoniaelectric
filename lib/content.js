...
async function getContent() {
  ...
  try {
    ...
    // Proyectos: una sola fuente para web, inicio y portafolio
    content.proyectos = {
      ...(defaults.proyectos || {}),
      ...(content.proyectos || {}),
      items:
        content.proyectos?.items?.length
          ? content.proyectos.items
          : defaults.proyectos.items,
    };
    ...
    const arrayKeys = ['stats', 'introParagraphs', 'strengths', 'services', 'divisions', 'processSteps'];
