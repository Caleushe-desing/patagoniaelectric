...
function defaultContent() {
  return {
    ...
    portafolio: {
      published: true,
      showInNav: true,
      coverTitle: 'Portafolio Corporativo',
      coverSubtitle: 'Ingeniería eléctrica, automatización industrial y montaje eléctrico',
      ...
      introParagraphs: [
        'Un grupo multidisciplinario de profesionales de distintas áreas componen nuestro equipo: seguridad, logística, ingeniería, técnicos y ayudantes en constante capacitación constituyen la pieza fundamental de nuestra compañía, el equipo humano.',
        'Patagonia Eléctric es una empresa chilena con capitales chilenos de la ciudad de Frutillar en la Región de los Lagos.',
        'Contamos con más de 10 años de experiencia en el desarrollo de proyectos eléctricos y en automatización industrial.',
      ],
      strengthsTitle: 'Por qué trabajar con nosotros',
      strengths: [
        { title: 'Equipo Multidisciplinario', text: 'Capacitamos a nuestro equipo de manera continua.' },
        { title: 'Certificaciones', text: 'Certificaciones para el personal técnico.' },
        { title: 'Alianzas', text: 'Cooperación comercial con las principales marcas eléctricas de Chile.' },
        {
          title: 'Garantía Post venta',
          text: 'Una vez que se convierten en nuestros clientes, siempre lo serán; respaldamos nuestros trabajos de por vida.',
        },
      ...
      divisions: [
        ...
        {
          title: 'División Ecológica',
          text: 'Energías renovables y soluciones sustentables. Paneles solares fotovoltaicos y eficiencia energética.',
        },
        {
          title: 'Habitacional',
          text: 'Instalaciones eléctricas para viviendas y edificaciones. Acometida, distribución, protecciones e iluminación certificada.',
      ...
      clientsSubtitle: 'Empresas que respaldan nuestro trabajo',
      clients: [
        { name: 'Nestlé', logo: '/images/cliente-nestle.png' },
        { name: "Papa John's", logo: '/images/cliente-papajohns.png' },
        { name: 'Zero Corp', logo: '/images/cliente-zero.jpg' },
      ],
      closingTitle: '¿Tiene un proyecto?',
      closingText: 'Contáctenos y reciba asesoría experta para su próximo proyecto eléctrico.',
...
async function getContent() {
  ...
  try {
    ...
    content.portafolio = {
      ...defaults.portafolio,
      ...(content.portafolio || {}),
      published: content.portafolio?.published ?? defaults.portafolio.published,
      showInNav: content.portafolio?.showInNav ?? defaults.portafolio.showInNav,
      introParagraphs: content.portafolio?.introParagraphs?.length
        ? content.portafolio.introParagraphs
        : defaults.portafolio.introParagraphs,
      strengths: content.portafolio?.strengths?.length ? content.portafolio.strengths : defaults.portafolio.strengths,
      divisions: content.portafolio?.divisions?.length ? content.portafolio.divisions : defaults.portafolio.divisions,
      projects: content.portafolio?.projects?.length ? content.portafolio.projects : defaults.portafolio.projects,
      clients: content.portafolio?.clients?.length ? content.portafolio.clients : defaults.portafolio.clients,
    };
    return content;
  } catch {
